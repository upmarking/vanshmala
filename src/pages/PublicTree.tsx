...
const PublicTree = () => {
  ...
  // Wrapped handleViewProfile and handleAddRelative in useCallback to prevent them
  // from being recreated on every render of PublicTree. Because these are passed down
  // to the highly recursive TreeNode component (which is wrapped in React.memo()),
  // keeping the function reference stable prevents expensive cascading re-renders.
