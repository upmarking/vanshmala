...
──────────────────────────────────────────────────────────── */
// Performance optimization: Wrapped in React.memo to prevent expensive cascading re-renders
...
──────────────────────────────────────────────────────────── */
// Performance optimization: Wrapped in React.memo to prevent expensive cascading re-renders
export const TreeNode = memo(function TreeNodeComponent({ member, depth = 0, onAddRelative, onViewProfile }: TreeNodeProps) {
