...
export const FeedList = ({ refreshTrigger, filterType = "all" }: FeedListProps) => {
    ...
    const fetchPosts = async () => {
        try {
            ...
            // Gather all unique profile IDs from all comments across all posts
            ...
            // Batch fetch all needed profiles once
            ...
            // Map the data synchronously now that we have all profiles
