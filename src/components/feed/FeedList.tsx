...
export const FeedList = ({ refreshTrigger, filterType = "all" }: FeedListProps) => {
    ...
    const fetchPosts = async () => {
        try {
            ...
            // ⚡ Bolt Performance Optimization: Extract all unique profile IDs from all comments across all posts
            // to prevent N+1 queries when rendering the feed.
            ...
            // Batch fetch all required profiles at once
            ...
            // Map posts synchronously now that we have all required data
