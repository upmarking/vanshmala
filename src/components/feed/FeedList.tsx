...
export const FeedList = ({ refreshTrigger, filterType = "all" }: FeedListProps) => {
    ...
    const fetchPosts = async () => {
        try {
            ...
            // Collect all unique profile_ids from all comments across all posts to batch-fetch profile info
            // ⚡ Bolt: Prevent N+1 queries by fetching all comment authors in a single query
